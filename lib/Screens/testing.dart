...
import 'package:near_me/constants.dart'; // Stores the Google Maps API Key
...
class _MapViewState extends State<MapView> {
  ...
  void initState() {
    ...
    destinationAddressController.text = widget.stop;
    _startAddress = widget.start;
    _destinationAddress = widget.stop;
  }
